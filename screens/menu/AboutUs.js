    ...
    render() {
        return (
            <ScrollView style={{ backgroundColor: '#FCFFFD', height: '100%' }}>
                ...
                <Text style={{ color: '#0E142A', backgroundColor: 'transparent', fontWeight: 'bold', fontSize: 18, margin: 12, marginTop: 20}}>عن دار ابن الجوزي</Text>
                <Text style={{ color: '#126330', backgroundColor: '#F5FAF7', fontSize: 16, padding: 12, marginTop: 10}}>{`
