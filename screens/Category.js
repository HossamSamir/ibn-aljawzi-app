...
export default class Category extends React.Component {
    ...
    doTheFetching() {
        ...
        fetch('https://016709f0.ngrok.io/api/sub_categories?parent_cat_id='+this.props.navigation.state.params.main_cat_id).
        ...
        // Fetch all books
        fetch('https://016709f0.ngrok.io/api/books_of_cat?cat_id='+this.props.navigation.state.params.main_cat_id).
            then((res) => res.json()).then((resJson) => {
